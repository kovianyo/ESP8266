...
local function printFileSystemInfo()
  ...
  local precentage = used / total * 100
  local roundedPercentage = string.format("%.2f", precentage) -- round to two decimal places
  print("File system: used: " .. roundedPercentage .. " %, " .. used .. " out of " .. total .. " bytes")
end
